...
const data: DataType = {
  ...
  profile: {
    about: [
      { property: 'Full Name', value: 'Taikool', icon: 'mdi:account-outline' },
    ...
    contacts: [
      ...
      { property: 'Skype', value: 'taikool.nguyen', icon: 'mdi:message-outline' },
      { property: 'Email', value: 'taikool.nguyen@example.com', icon: 'mdi:email-outline' }
    ],
    teams: [
  ...
  teams: [
    ...
    },
    {
      ...
      avatarGroup: [
        ...
        { avatar: '/images/avatars/6.png', name: 'Taikool' },
  ...
  projects: [
    ...
    },
    {
      ...
      avatarGroup: [
        ...
        { avatar: '/images/avatars/5.png', name: 'Taikool' },
