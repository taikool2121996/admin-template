    ...
    <Grid container spacing={5}>
      ...
      <Grid item xs={12} md={6}>
        <FormControl fullWidth>
          <TextField label='First Name' placeholder='Taikool' />
        </FormControl>
      </Grid>
      <Grid item xs={12} md={6}>
        <FormControl fullWidth>
      ...
      <Grid item xs={12} md={6}>
        <TextField fullWidth label='Username' placeholder='taikool.nguyen' />
      </Grid>
      <Grid item xs={12} md={6}>
        <TextField
          fullWidth
      ...
      <Grid item xs={12} md={6}>
        <TextField fullWidth type='email' label='Email' placeholder='taikool.nguyen@email.com' />
      </Grid>
      <Grid item xs={12} md={6}>
        <TextField
          fullWidth
